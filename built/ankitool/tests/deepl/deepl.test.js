...
describe("[Deepl Module] deepl.retrieve ", function () {
    ...
    it('doesn\'t throw an error', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect((0, index_js_1.getTargetsDeepL)(word, requestOptions)).resolves.toBeTruthy()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
describe("[Deepl Module Error] deepl.retrieve", function () {
    ...
    var word = 'oie';
    it('throws error on lack of API key', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Should throw error that 
                return [4 /*yield*/, expect((0, index_js_1.getTargetsDeepL)(word, requestOptions)).rejects.toThrow()];
                case 1:
                    // Should throw error that 
                    _a.sent();
                    return [2 /*return*/];
